...
export const communitiesData: Record<string, CommunityContent> = {
  'personal-trainer-charleston-sc': {
    ...
    seoTitle: 'Best Personal Trainer Charleston SC | Elite Fitness Coaching',
    metaDesc: 'Elevate your fitness with the best personal trainer in Charleston SC. Custom fat loss and muscle building systems from a premier body transformation specialist.',
    h1: 'ELITE PERSONAL TRAINING IN DOWNTOWN CHARLESTON',
    subheading: 'High-performance body architecture for the modern professional.',
    intro: 'Training in Charleston requires a plan that balances a high-paced professional life with the city’s vibrant social scene. As your dedicated Charleston SC personal trainer, we provide the structure you need to succeed, ensuring your physical performance matches your professional ambition.',
    lifestyle: {
  ...
  'personal-training-mount-pleasant-sc': {
    ...
    seoTitle: 'Personal Training Mount Pleasant SC | Body Transformation',
    metaDesc: 'Premium personal training in Mount Pleasant SC. Tailored weight loss coaching and strength training for busy professionals near Shem Creek and Old Village.',
    h1: 'PREMIUM FITNESS COACHING IN MOUNT PLEASANT',
    subheading: 'Precision training for the Mount Pleasant lifestyle.',
